...
def main():
    ...
    print("    Use validate_similarity_fixtures.py instead to preserve Crucible formatting.\n")
    ...
    print("   2. If Crucible owns the format, use validate_similarity_fixtures.py instead")
    print("   3. Run: uv run pytest tests/unit/foundry/similarity (once tests are updated)")
