...
| Documentation                | Core                | Access and processing of Crucible documentation assets including frontmatter extraction and clean content reads                      | [Documentation](../../standards/library/modules/documentation.md)                             |
