...
**Issue**: `tests/unit/pathfinder/test_models.py` collided with `tests/unit/foundry/test_models.py`, causing pytest to fail with "imported module 'test_models' has this __file__ attribute" error.
