...
class TestAliasedMetric:
    ...
    def test_aliased_counter_inc(self):
        ...
        with patch.dict(os.environ, {"PYFULMEN_TELEMETRY_ALIAS": "true"}):
            aliased = create_aliased_counter(
                registry, 
                canonical_name="canonical_counter",
                legacy_name="legacy_counter"
            )
    ...
    def test_aliased_gauge_set(self):
        ...
        with patch.dict(os.environ, {"PYFULMEN_TELEMETRY_ALIAS": "true"}):
            aliased = create_aliased_gauge(
                registry, 
                canonical_name="canonical_gauge",
                legacy_name="legacy_gauge"
            )
    ...
    def test_aliased_histogram_observe(self):
        ...
        with patch.dict(os.environ, {"PYFULMEN_TELEMETRY_ALIAS": "true"}):
            aliased = create_aliased_histogram(
                registry, 
                canonical_name="canonical_histogram",
                legacy_name="legacy_histogram",
