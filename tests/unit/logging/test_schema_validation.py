...
pytestmark = pytest.mark.skip(
    reason="Requires local schema resolver - schemas use remote $id URLs not yet published"
)
...
class TestLogEventSchemaValidation:
    ...
    def test_minimal_log_event_validates(self):
        ...
        validate_against_schema(
            data=event, category="observability/logging", version="v1.0.0", name="log-event"
        )
    ...
    def test_generated_simple_event_validates(self):
        ...
        validate_against_schema(
            data=event_data, category="observability/logging", version="v1.0.0", name="log-event"
        )
...
class TestLoggerConfigSchemaValidation:
    ...
    def test_simple_config_validates(self):
        ...
        validate_against_schema(
            data=config, category="observability/logging", version="v1.0.0", name="logger-config"
        )
...
class TestLoggingPolicySchemaValidation:
    ...
    def test_minimal_policy_validates(self):
        ...
        validate_against_schema(
            data=policy, category="observability/logging", version="v1.0.0", name="logging-policy"
        )
