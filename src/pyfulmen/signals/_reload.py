...
class ConfigReloader:
    ...
    def reload_config(self) -> None:
        ...
        self._logger.info(
            ...
            context={
                "event_type": "config_reload_start",
                "strategy": "restart_based"
            }
        )
    ...
    def _validate_new_config(self) -> None:
        ...
        self._logger.info(
            ...
            context={"event_type": "config_validation_start"}
        )
    ...
    def _execute_shutdown_callbacks(self) -> None:
        ...
        self._logger.info(
            ...
            context={
                "event_type": "shutdown_callbacks_start",
        ...
        for i, callback in enumerate(self._shutdown_callbacks):
            try:
                ...
                self._logger.debug(
                    ...
                    context={
                        "event_type": "shutdown_callback_complete",
                        "callback_index": i + 1
                    }
                )
            except Exception as e:
                self._logger.warn(
                    ...
                    context={
                        "event_type": "shutdown_callback_failed",
                        "callback_index": i + 1,
                        "error": str(e)
                    }
                )
        ...
        self._logger.info(
            "Graceful shutdown callbacks completed",
            context={"event_type": "shutdown_callbacks_complete"}
        )
    ...
    def _restart_process(self) -> None:
        ...
        try:
            ...
            self._logger.info(
                "Process restart initiated successfully",
                context={"event_type": "process_restart_success"}
            )
